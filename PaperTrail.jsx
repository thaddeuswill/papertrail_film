...
const styles = `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; -webkit-tap-highlight-color: transparent; }
  ...
  .hero-title { font-family: 'Playfair Display', serif; font-size: clamp(3.2rem, 16vw, 8rem); font-weight: 900; line-height: 0.88; color: var(--cream); letter-spacing: -0.01em; text-shadow: 0 8px 60px rgba(139,37,0,0.25); }
  ...
  .hero-body { display: grid; grid-template-columns: 1fr; gap: 0; max-width: 740px; width: 100%; margin: 0 auto; padding: 0 20px; flex: 1; }
